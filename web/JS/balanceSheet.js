...
window.onload = function () {
  ...
  var url = 'https://www.alphavantage.co/query?function=BALANCE_SHEET&symbol='+searchContent+'&apikey=OOEPKQDKWRUGS4HV';
  ...
  balance_chart.onload = function() {
    ...
    var totalAsset0 = parseFloat(d.annualReports[0].totalAssets);
    var totalAsset1 = parseFloat(d.annualReports[1].totalAssets);
    var totalAsset2 = parseFloat(d.annualReports[2].totalAssets);
    var totalAsset3 = parseFloat(d.annualReports[3].totalAssets);
    var totalAsset4 = parseFloat(d.annualReports[4].totalAssets);

    //Total Liabilitiess for graphs
    var totalLiabilities0 = parseFloat(d.annualReports[0].totalLiabilities);
    var totalLiabilities1 = parseFloat(d.annualReports[1].totalLiabilities);
    var totalLiabilities2 = parseFloat(d.annualReports[2].totalLiabilities);
    var totalLiabilities3 = parseFloat(d.annualReports[3].totalLiabilities);
    var totalLiabilities4 = parseFloat(d.annualReports[4].totalLiabilities);
...
var balance_sheet = new XMLHttpRequest();
  
  var url = 'https://www.alphavantage.co/query?function=BALANCE_SHEET&symbol='+searchContent+'&apikey=OOEPKQDKWRUGS4HV';
  balance_sheet.open('GET', url, true);
  balance_sheet.onload = function() {
    var d = JSON.parse(this.response);
    console.log(d.annualReports[0]);
    ...
    var totalLiabilities0 = commaseparator(parseFloat(d.annualReports[0].totalLiabilities));
    var totalLiabilities1 = commaseparator(parseFloat(d.annualReports[1].totalLiabilities));
    var totalLiabilities2 = commaseparator(parseFloat(d.annualReports[2].totalLiabilities));
    var totalLiabilities3 = commaseparator(parseFloat(d.annualReports[3].totalLiabilities));
    var totalLiabilities4 = commaseparator(parseFloat(d.annualReports[4].totalLiabilities));
