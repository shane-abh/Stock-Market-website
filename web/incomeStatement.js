...
window.onload = function () {
  ...
  var url = 'https://www.alphavantage.co/query?function=INCOME_STATEMENT&symbol=' + searchContent + '&apikey=OOEPKQDKWRUGS4HV';
  ...
  income_st_chart.onload = function() {
    ...
    //Revenue for graphs    
    var revenue0 = parseFloat(d.annualReports[0].totalRevenue);
    var revenue1 = parseFloat(d.annualReports[1].totalRevenue);
    var revenue2 = parseFloat(d.annualReports[2].totalRevenue);
    var revenue3 = parseFloat(d.annualReports[3].totalRevenue);
    var revenue4 = parseFloat(d.annualReports[4].totalRevenue);

    //gross profits for graphs
    var gross_profit0 = parseFloat(d.annualReports[0].grossProfit);
    var gross_profit1 = parseFloat(d.annualReports[1].grossProfit);
    var gross_profit2 = parseFloat(d.annualReports[2].grossProfit);
    var gross_profit3 = parseFloat(d.annualReports[3].grossProfit);
    var gross_profit4 = parseFloat(d.annualReports[4].grossProfit);
...
var income_st = new XMLHttpRequest();
  
  var url = 'https://www.alphavantage.co/query?function=INCOME_STATEMENT&symbol=' + searchContent + '&apikey=OOEPKQDKWRUGS4HV';
  income_st.open('GET', url, true);
  income_st.onload = function() {
    var d = JSON.parse(this.response);
